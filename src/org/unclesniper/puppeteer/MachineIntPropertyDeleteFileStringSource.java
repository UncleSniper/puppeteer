...
@ShorthandName("machineIntPropertyDeleteFileString")
public class MachineIntPropertyDeleteFileStringSource extends AbstractMachineIntPropertyReference
		implements DeleteFileStringSource {

	public MachineIntPropertyDeleteFileStringSource() {}
